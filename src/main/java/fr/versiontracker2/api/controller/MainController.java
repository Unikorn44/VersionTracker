...
import fr.versiontracker2.traitement.service.MailService;
...
public class MainController {
	...
	private static final String LIST_FILE_APPLICATIONS = "listFileApplications";
	...
	public String contact(MailContact mailContact,
		...
		mailService.sendMail(mailContact, skinner);
		return "index";
	}
}
